...
import VideoT from "./images/VideoT.png"
import VideoTestimonio from "./images/VideoTestimonio.webp"
  ...
  return (
    ...
    <img style={{width:"100%"}} src={Testimonios} />
      <div style={{
        ...
        <img style={{width:"45%"}} src={VideoTestimonio}/> 
        </a>
      </div>
      ...
      <div style={{
        ...
        <a href='https://www.youtube.com/watch?v=pwTlSejnDsE' target="_blank">
        <img style={{width:"100%"}} src={VideoTestimonio}/> 
        </a>
      </div>
