...
import CambiodeclaveWIFIWASI  from "./../../PDF/CambiodeclaveWIFIWASI.pdf"
...
export default class ModalAcordeon2 extends Component {
  ...
  render() {
    ...
    return (
      <Accordion style={{maxWidth:"450px"}}>
        <Accordion.Title
...
Contraseñas que hayas usado antes en tus cuentas.</li>
          <br/>
          <p>
            Descarga nuestro sencillo manual  
            <a href={CambiodeclaveWIFIWASI} target="_blank"> 
            &nbsp; Aquí.
            </a>
          </p>        </Accordion.Content>
