  ...
  return (
    <>
     <Helmet>
        ...
        <meta name='keywords' content='Amor, San Valentin, Peliculas, Que Ver, Peliculas Romanticas' />
    </Helmet>
    <div>

      
<p style={{paddingTop:"120px",fontSize:"40px",textAlign:"center", fontFamily:"Poppins, sans-serif", fontWeight:"400",color:"#00267d"}}><strong>Las 5 películas que Wasi te recomienda en este San Valentín
espacios.</strong></p>
      <img  style={{
        width:"40%",
        minWidth:"400px",
