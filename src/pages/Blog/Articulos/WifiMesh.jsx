...
const WifiMesh = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name='keywords' content='Wifi Mesh, Beneficios Mesh, Comprar Mesh'/>
    </Helmet>
    <div>

      
<p style={{paddingTop:"120px",fontSize:"40px",textAlign:"center", fontFamily:"Poppins, sans-serif", fontWeight:"400",color:"#00267d"}}><strong>Las redes Wifi-Mesh, una solución de conexión en grandes
espacios.</strong></p>
      <img  style={{
        width:"40%",
        minWidth:"400px",
