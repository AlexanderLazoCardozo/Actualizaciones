...
const ComidasSemS = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name='keywords' content='Semana Santa, Mejores Platos, Comida'/>
    </Helmet>
    <div>
    
      
<p style={{paddingTop:"120px",fontSize:"40px",textAlign:"center", fontFamily:"Poppins, sans-serif", fontWeight:"400",color:"#00267d"}}><strong>¿Comida santa? Los mejores platos para disfrutar en esta semana
santa.</strong></p>
      <img  style={{
        width:"40%",
        minWidth:"400px",
