...
const SemanaSanta = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name='description' content="Wasi te recomienda las mejores peliculas para esta semana Santa. Reflexivas, emocionantes y épicas para ver con toda la familia." />
        <meta name='keywords' content='Mejores Peliculas, Semana Santa, Reflexion, Familia' /> 
    </Helmet>
    <div>

      <p style={{paddingTop:"120px",fontSize:"40px",textAlign:"center", fontFamily:"Poppins, sans-serif", fontWeight:"400",color:"#00267d"}}><strong>Las mejores peliculas para esta Semana Santa.</strong></p>
