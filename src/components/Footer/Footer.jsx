...
const Footer = () => {
  ...
  return (
    <>
    <StyleFooter>
    <div  id='computer' style={{backgroundColor:"#E8E8E8", height:"450px", paddingTop:"56px"}}>   
        <br />
        <Grid centered  >
        <Grid.Row  columns={5}>
        <Grid.Column>
            <Grid>
                <Grid.Row>
                <img style={{width:"200px",marginTop:"50px",marginLeft:"-40px"}} src={logoWasiUP}></img>
                </Grid.Row>
...
<br/>
    ...
    <div >
        ...
        <Grid centered columns={8}>
                <Grid.Row>
                <img style={{width:"200px"}} src={logoWasiUP}></img>
                </Grid.Row>
