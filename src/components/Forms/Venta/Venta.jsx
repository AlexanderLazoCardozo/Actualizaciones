...
const Venta = () => {
  ...
  return (
    ...
    <main>
			...
			<Formulario action="https://getform.io/f/c414478f-d5fd-4060-be9d-69ef99bfcafa" method="POST" onSubmit={onSubmit}>
				<Input
					estado={nombre}
            ...
            <select required style={{height:"45px", marginTop:"20px"}} name='Tipo De Solicitud'>
