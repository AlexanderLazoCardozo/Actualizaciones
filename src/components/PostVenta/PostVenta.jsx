...
import PdfPostVenta from './PdfPostVenta';
  ...
  return (
    ...
    <main>
			...
			<div style={{textAlign:"center", marginTop:"100px"}}>
				...
				<div >
				<b style={{color:"black",fontSize:"35px"}}>Solicitudes en Línea - Post Venta</b> <br/><br/>
                </div>
                <br />
			...
			<Formulario action="https://getform.io/f/1ffbe33a-762a-4810-8d55-a8e59d3939d8" method="POST" onSubmit={onSubmit}>
				<Input
					estado={nombre}
				...
				<select required style={{height:"45px", marginTop:"40px"}} name='Tipo De Solicitud'>
				...
				placeholder='Observaciones (Detalle de Solicitud)' 
