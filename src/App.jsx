...
import Evo from './pages/Blog/Articulos/Evo'
import Champions from './pages/Blog/Articulos/Champions'
import PeruVsNZ from './pages/Blog/Articulos/PeruVsNZ'
import Qatar2022 from './pages/Blog/Articulos/Qatar2022'
    ...
    <BrowserRouter>
        <Routes>
          <Route path='/' element={<Navbar />}>
              ...
              <Route path='Blog/Evo-Championship-el-mundial-de-los-juegos-de-lucha' element={<Evo />} />
              <Route path='Blog/Uefa-Champions-League' element={<Champions />} />
              <Route path='Blog/Peru-y-Nueva-Zelanda-se-vuelven-a-ver-las-caras' element={<PeruVsNZ />} />
              <Route path='Blog/Qatar-2022-pais-de-los-turbantes' element={<Qatar2022 />} />
